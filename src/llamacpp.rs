...
/// Check whether a URL is reachable by TCP connect.
/// Check whether a URL is reachable by TCP connect.
///
/// Used to probe whether the llama.cpp server has started listening.
...
/// Query the running llama.cpp server for the loaded model name.
...
/// Stop the managed llama.cpp server and release GPU memory.
///
