...
- ozone+ real backend integration and context assembly are still unimplemented; the current ozone+ frontend is now a real TUI shell, but assistant replies still come from a mock runtime until Phase 1D
